...
After this, we hide the~CHMI logo by masking a~270x115 rectangle in the~top right and the~weather measurements by masking a~250x250 rectangle in the~top left. The~process is shown in \figref{segmentation_single_images}.
